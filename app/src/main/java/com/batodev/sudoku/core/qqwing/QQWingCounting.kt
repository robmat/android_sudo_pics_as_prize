 ...
 */
internal fun QQWing.countSolutions(): Int = countSolutions(false)
 ...
 * multiple solutions.
 */
internal fun QQWing.countSolutionsLimited(): Int = countSolutions(true)
...
internal fun QQWing.countSolutions(
    round: Int,
    limitToTwo: Boolean,
): Int {
...
private fun QQWing.countSolutionsByGuessing(
    round: Int,
    limitToTwo: Boolean,
): Int {
    var solutions = 0
