 ...
 * row/column/section.
 */
internal class NakedPairTechniques(private val board: QQWing) {
    ...
    fun arePossibilitiesSame(position1: Int, position2: Int): Boolean {
        for (valIndex in 0 until QQWing.ROW_COL_SEC_SIZE) {
    ...
    fun removePossibilitiesInOneFromTwo(position1: Int, position2: Int, round: Int): Boolean {
    ...
    private fun tryHandleNakedPairsAt(round: Int, position: Int): Boolean {
    ...
    private fun isNakedPairCandidate(position: Int, position2: Int): Boolean {
        return position != position2 && countPossibilities(position2) == 2 && arePossibilitiesSame(position, position2)
    }

    private fun tryReduceRow(round: Int, position: Int, position2: Int, row: Int): Boolean {
        var doneSomething = false
    ...
    private fun tryReduceColumn(round: Int, position: Int, position2: Int, column: Int): Boolean {
        var doneSomething = false
    ...
    private fun tryReduceSection(round: Int, position: Int, position2: Int): Boolean {
        var doneSomething = false
