...
import com.batodev.sudoku.data.datastore.setLastSelectedGameDifficultyType
...
class HomeViewModel
    ...
    constructor(
        ...
        val lastSelectedGameDifficultyType =
            appSettingsManager.lastSelectedGameDifficultyType
                .stateIn(
                    viewModelScope,
        ...
        val saveSelectedGameDifficultyType =
            appSettingsManager.saveSelectedGameDifficultyType
                .stateIn(
                    viewModelScope,
                    SharingStarted.Eagerly,
